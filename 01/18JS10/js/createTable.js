...
function createTable(data) {
	...
	tr.innerHTML = '<th>商品</th><th>地区th><th>1月</th><th>2月</th><th>3月</th><th>4月</th><th>5月</th><th>6月</th><th>7月</th><th>8月</th><th>9月</th><th>10月</th><th>11月</th><th>12月</th>'
    		...
    		if (Array.isArray(data[i][key])){
    			...
    			img.onclick = function (event) {
    				let e = event || window.event,
    				    ...
    				    target.parentNode.children[2].setAttribute("style","dispaly:block");
